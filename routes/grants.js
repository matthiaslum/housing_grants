...
try{
    ...
    // console.log('total income query', req.query.totalincome);
    // console.log('housing type', house_type);
    // console.log('max_income', Number.isNaN(max_income), max_income);
    // console.log('max_size', typeof(max_size), max_size);
